        ...
        <div>
            <AppBar position="sticky" style={{ background: 'white' }}>
                <Container maxWidth="xl" className="top-nav-container" style={{ padding: '0.75rem 5rem' }}>
                    <Toolbar disableGutters>
                        ...
                        <Box className='search-area'>
                            ...
                            >
                                {props.locData.map((option) => (
                                    <MenuItem key={option} value={option}>{option}</MenuItem>
                                ))}
                            </TextField>
                            <button className='search-btn' title="Search" onClick={() => props.getSearchedDestination(country)}><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", fill: "none", height: "12px", width: "12px", stroke: "white", strokeWidth: "5.33333", overflow: "visible" }}><g fill="none"><path d="m13 24c6.0751322 0 11-4.9248678 11-11 0-6.07513225-4.9248678-11-11-11-6.07513225 0-11 4.92486775-11 11 0 6.0751322 4.92486775 11 11 11zm8-3 9 9"></path></g></svg></button>
                            <button className='clear-btn' title="Clear" onClick={handleClick}><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", fill: "none", height: "12px", width: "12px", strokeWidth: "4", overflow: "visible", stroke: "white" }}><path d="m6 6 20 20"></path><path d="m26 6-20 20"></path></svg></button>

                        </Box>
                        <Box className="host-section">
                            <Tooltip title="Open settings">
                                <Button className='menu-btn' variant="outlined" onClick={handleOpenUserMenu} startIcon={<MenuIcon />} endIcon={<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: "block", width: "30px", height: "30px", fill: "#717171" }}><path d="m16 .7c-8.437 0-15.3 6.863-15.3 15.3s6.863 15.3 15.3 15.3 15.3-6.863 15.3-15.3-6.863-15.3-15.3-15.3zm0 28c-4.021 0-7.605-1.884-9.933-4.81a12.425 12.425 0 0 1 6.451-4.4 6.507 6.507 0 0 1 -3.018-5.49c0-3.584 2.916-6.5 6.5-6.5s6.5 2.916 6.5 6.5a6.513 6.513 0 0 1 -3.019 5.491 12.42 12.42 0 0 1 6.452 4.4c-2.328 2.925-5.912 4.809-9.933 4.809z"></path></svg>} disableRipple />
                            </Tooltip>
                            <Menu
                                sx={{ mt: '45px' }}
                                id="menu-appbar"
                            ...
                            >
                                ...
                                <hr />
                                <MenuItem onClick={handleCloseUserMenu}>
                                    <Typography textAlign="center">Host your home</Typography>
                                </MenuItem>
                                <MenuItem onClick={handleCloseUserMenu}>
                                    <Typography textAlign="center">Host an experience</Typography>
                                </MenuItem>
                                <MenuItem onClick={handleCloseUserMenu}>
                ...
                <Container maxWidth="xl" style={{ padding: '0rem 5rem' }}>
                    <Box sx={{ Width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        >
                            <Tab icon={<img src={require("./images/islands.jpg")} alt="img" width="25" height="25" />} label="Islands" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/arctic.jpg")} alt="img" width="25" height="25" />} label="Arctic" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/pools.jpg")} alt="img" width="25" height="25" />} label="Amazing pools" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/omg.jpg")} alt="img" width="25" height="25" />} label="OMG!" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/surfing.jpg")} alt="img" width="25" height="25" />} label="Surfing" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/shared-home.jpg")} alt="img" width="25" height="25" />} label="Shared homes" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/design.jpg")} alt="img" width="25" height="25" />} label="Design" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/park.jpg")} alt="img" width="25" height="25" />} label="National parks" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/country-side.jpg")} alt="img" width="25" height="25" />} label="Countryside" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<img src={require("./images/caves.jpg")} alt="img" width="25" height="25" />} label="Caves" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<FavoriteIcon />} label="Tropical" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<PersonPinIcon />} label="Tiny homes" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<PhoneIcon />} label="Earth homes" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<FavoriteIcon />} label="Golfing" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<PersonPinIcon />} label="A-frames" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<PhoneIcon />} label="Luxe" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<FavoriteIcon />} label="Farms" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                            <Tab icon={<PersonPinIcon />} label="Amazing views" style={{ textTransform: "none", fontSize: "12px", color: "black" }} />
                        </Tabs>
                        <button className="filter-btn" onClick={handleDialogOpen}><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", height: "14px", width: "14px", fill: "black" }} aria-hidden="true" role="presentation" focusable="false"><path d="M5 8c1.306 0 2.418.835 2.83 2H14v2H7.829A3.001 3.001 0 1 1 5 8zm0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm6-8a3 3 0 1 1-2.829 4H2V4h6.17A3.001 3.001 0 0 1 11 2zm0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path></svg>
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button onClick={handlePriceChange} autoFocus>
                        Apply
                    </Button>
                </DialogActions>
            </Dialog>
